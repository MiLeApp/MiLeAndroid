 ...
 */
public abstract class CursorContactsRecyclerViewAdapter extends RecyclerView.Adapter<CursorContactsRecyclerViewAdapter.ViewHolder> {
    ...
    public CursorContactsRecyclerViewAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    ...
    public abstract void onBindViewHolder(CursorContactsRecyclerViewAdapter.ViewHolder viewHolder, Cursor cursor);
    @Override
    public void onBindViewHolder(CursorContactsRecyclerViewAdapter.ViewHolder viewHolder, int position) {
        if (!mDataValid) {
